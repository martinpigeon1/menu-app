...
const SYSTEM_PROMPT = `Tu es un assistant culinaire. Extrais depuis cette photo de recette:
1. Les métadonnées: titre, nombre de portions, temps de préparation, temps de cuisson
    ...
    messages: [
      {
        ...
        content: [
          ...
          { type: 'text', text: 'Extrais les ingrédients et les étapes de cette recette.' },
        ],
      },
    ],
  })
